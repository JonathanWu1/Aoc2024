...
int main() {
    ...
    for (int i = 0; i < SIZE; i++) {
        for (int j = 0; j < SIZE; j++) {
            hcount += checkHorizontal(i, j, "XMAS");
            hcount += checkHorizontal(i, j, "SAMX");

            vcount += checkVertical(i, j, "XMAS");
            vcount += checkVertical(i, j, "SAMX");

            dlcount += checkDiagonalLeft(i, j, "XMAS");
            dlcount += checkDiagonalLeft(i, j, "SAMX");

            drcount += checkDiagonalRight(i, j, "XMAS");
            drcount += checkDiagonalRight(i, j, "SAMX");
        }
    }
